# Internal Team/Company Information Questionnaire

**Purpose:** Gather information about YOUR team, company, and internal situation to complete negotiation preparation files.

**Instructions:** Answer these questions to populate the negotiation documents in the other chat. Focus on YOUR side of the negotiation, not the client or technical project details.
...
### Core Team (from roadmap: mentions "Kiriana" and technical/non-technical roles)
...
## 💰 SECTION 3: YOUR COSTS & FINANCIAL SITUATION
...
## 🎯 SECTION 4: YOUR CAPABILITIES & PORTFOLIO
...
## 🚀 SECTION 5: YOUR LEVERAGE & ADVANTAGES
...
## 🎭 SECTION 6: YOUR BATNA (Best Alternative to Negotiated Agreement)
...
## 📅 SECTION 7: YOUR TIMELINE & CONSTRAINTS
...
## 🤝 SECTION 8: YOUR NEGOTIATION STYLE & PREFERENCES
...
## 💡 SECTION 9: YOUR VALUE PROPOSITION
...
## 📊 SECTION 10: YOUR CONCESSION STRATEGY
...
## 🏢 SECTION 11: COMPANY PROFILE (for client materials)
...
1. **Contracts/Legal:**
   - Do you have standard contract templates? Yes / No
   - Have they been reviewed by a lawyer? Yes / No
   - Any legal concerns with this deal? _____

2. **Intellectual Property:**
   - Who owns the code you're selling?
     - [ ] You own it 100%
     - [ ] You own it, but used some open-source (which? _____ )
     - [ ] Complicated (explain: _____ )

3. **Liability/Risk:**
   - What's your liability if something goes wrong? _____
   - Do you have insurance? Yes / No
   - What are you NOT responsible for? _____

4. **Data/Privacy:**
   - Will you handle client data? Yes / No
   - GDPR/privacy compliance needed? Yes / No
   - Data security measures in place? _____

---

## 🎯 SECTION 13: YOUR GOALS FOR THIS DEAL
...
## 📝 SECTION 14: PAST LEARNINGS & EXPERIENCE

### What You've Learned

1. **Past negotiation wins:**
   - What worked well in previous deals? _____
   - What tactics were successful? _____

2. **Past negotiation losses:**
   - What went wrong? _____
   - What would you do differently? _____

3. **Red flags you've learned to watch for:**
   - Client red flags: _____
   - Deal red flags: _____
   - Negotiation red flags: _____

4. **Your gut feeling about THIS deal:**
   - On a scale of 1-10, how good does this feel? _____
   - Any concerns? _____
   - What's your intuition saying? _____

---

## 🚦 SECTION 15: DECISION-MAKING PROCESS

### How You Make Decisions

1. **Who makes final decision on your side?**
   - [ ] Just you
   - [ ] You + partner(s)
   - [ ] Team vote
   - [ ] Other: _____

2. **Decision criteria (rank 1-5):**
   - ___ Price/Revenue
   - ___ Client fit
   - ___ Technical challenge
   - ___ Learning opportunity
   - ___ Long-term potential
   - ___ Other: _____

3. **How quickly can you make decisions during negotiation?**
   - [ ] On the spot
   - [ ] Need to discuss with partner (how long? _____ )
   - [ ] Need time to think (how long? _____ )
   - [ ] Need to consult advisor/lawyer

---

## ✅ FINAL CHECKLIST

Before moving to create negotiation documents, ensure you've covered:

- [ ] Team roles and who does what in meeting
- [ ] Your actual costs (hours, infrastructure, opportunity cost)
- [ ] Minimum acceptable price (hard pass point)
- [ ] Target and stretch pricing goals
- [ ] Your BATNA and client's BATNA
- [ ] What makes you unique/different
- [ ] Timeline and delivery commitments
- [ ] Concessions you can/can't make
...
1. **Share answers in the other chat** to populate:
   - Stakeholder Analysis (your team)
...
2. **Keep this document updated** as you learn more about:
   - Your capabilities
   - Your costs
   - Your position

3. **Review before each meeting** to remind yourself of:
   - Your minimums
   - Your leverage
   - Your concessions
...
**Remember:** This is YOUR internal document. Be brutally honest. No one else will see this. The more accurate your answers, the better prepared you'll be.

**Key Context from Roadmap:**
- You mentioned "we are new"
- Hard pass < 15 units
- 2-month timeline
- Team roles: someone technical (demos), someone business (pricing)
- You have the leverage (product ready, low overhead, fast delivery)

---

**Last Updated:** 2025-10-16
**Status:** Template - Ready to Fill Out
